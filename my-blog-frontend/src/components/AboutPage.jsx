...
function AboutPage() {
  ...
  const sentence3 =
    "Every line of code is a small step toward something bigger.";
  ...
  return (
    <section className="section has-navbar-fixed-top">
      <div className="container">
        <div
          className="hero is-medium is-dark is-bold mb-5"
        ...
        <div className="box mb-5" style={{ borderRadius: "8px" }}>
          <div className="columns is-vcentered">
            ...
            <div className="column">
              ...
              <p className="content">
                A freshman majoring in CS from Zhejiang Univ. - Curious,
                consistent, and always building
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="columns mb-5">
          ...
          <div className="column is-8">
            <div
              className="box has-text-centered mb-4"
